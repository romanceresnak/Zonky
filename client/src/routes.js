...
import AddRoles from "./components/User/Admin/add_roles";
import RemoveRoles from "./components/User/Admin/remove_roles";
    ...
    <Layout>
      <Switch>
        ...
        <Route
          ...
          component={Auth(ManageCategories, true)}
        />
        <Route path="/admin/add_roles" exact component={Auth(AddRoles, true)} />
        <Route
          path="/admin/remove_roles"
          exact
          component={Auth(RemoveRoles, true)}
        />
